...
<div class="same_list_back">
	...
	<div class="pag">
		<span class="disabled">&lt; </span><a href="gllv.html">首 页</a><a
			href="gllv?page=${page.prev }">上一页</a>
		...
		<a href="gllv?page=${page.next }">下一页</a><a href="gllv?page=${page.last }">尾页</a>
	</div>
</div>