...
<div>
	<div>
		...
		<table width="598" border="0">
		  <tr>
		    <td height="37" colspan="5" align="left" bgcolor="#e0eafa"><span class="STYLE15">${order.name}</span></td>
		  </tr>
		  <tr>
		    <td height="37" colspan="5" align="left" bgcolor="#e0eafa"><span class="STYLE1">房型：${order.room.name }</span></td>
		  </tr>
		  <tr>
		    <td width="84" height="37" align="center" bgcolor="#e0eafa"><span class="STYLE2">项目</span></td>
		    <td width="126" align="center" bgcolor="#e0eafa"><span class="STYLE2">单价</span></td>
			<td width="147" align="center" bgcolor="#e0eafa"><span class="STYLE2">天数</span></td>
		    <td width="117" align="center" bgcolor="#e0eafa"><span class="STYLE2">数量</span></td>
		    <td width="102" align="center" bgcolor="#e0eafa"><span class="STYLE2">小计</span></td>
		  </tr>
		  <tr>
		    <td height="37" align="center" bgcolor="#e0eafa"><span class="STYLE2"></span></td>
		    <td align="center" bgcolor="#e0eafa"><span class="STYLE7">￥<c:out value="${order.room.todayPrice }" default="0"/>元</span></td>
		    <td align="center" bgcolor="#e0eafa"><span class="STYLE7"><c:out value="${order.days }" default="0"/>天</span></td>
		    <td align="center" bgcolor="#e0eafa"><span class="STYLE7"><c:out value="${order.num}" default="0"/>人</span></td>
		    <td align="center" bgcolor="#e0eafa"><span class="STYLE13">￥<c:out value="${order.price }" default="0"/>元</span></td>
		  </tr>
		  <tr>
		    <td height="42" colspan="5" align="right" bgcolor="#e0eafa" class="STYLE14">合计：￥<c:out value="${order.price }" default="0"/>元</td>
		  </tr>
		  <tr>
		    <td height="64" colspan="5" align="left" valign="top"><p class="STYLE2">请您下订单之后尽快选择一下付款方式付款，我们将保留您的订单48小时，如48小时后任然没有收到您的付款，我们将自动取消此订单。</p>
