...
@RooJavaBean
@RooToString
@RooJpaActiveRecord(finders = { "findRoomTypesByNameLike" })
public class RoomType {

    @Size(min = 1)
    private String name;

	public static TypedQuery<RoomType> findRoomTypesByNameLike(String name) {
        ...
        EntityManager em = RoomType.entityManager();
        TypedQuery<RoomType> q = em.createQuery("SELECT o FROM RoomType AS o WHERE LOWER(o.name) LIKE LOWER(:name)", RoomType.class);
	...
	public static RoomType findRoomType(Long id) {
